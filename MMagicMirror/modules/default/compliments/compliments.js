...
Module.register("compliments", {
	...
	defaults: {
		compliments: {
			anytime: ["Controla con gestos el espejo"],
			morning: ["Buenos días", "Disfruta de tu día", "¿Has dormido bien?"],
			afternoon: ["Cada día es una oportunidad", "Espejito, espejito...", "Se te ve bien hoy"],
			evening: ["El universo es tu espejo","Te ves bien y tu espejo lo sabe", "¡Buenas noches!"],
